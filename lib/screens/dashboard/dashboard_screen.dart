...
class _HomeTab extends StatelessWidget {
      ...
      if (p.upcomingEvents.isEmpty) {
        return Container(
          ...
          child: Column(children: [
            ...
            Text(
              'Start planning your next special occasion!',
              style: TextStyle(
          ...
          Row(children: [
            Expanded(
              child: GestureDetector(
                ...
                child: OverviewCard(
                  title: 'Total Events',
                  value: p.events.length.toString(),
                  icon: Icons.event,
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: OverviewCard(
                  title: 'Upcoming',
                  value: p.upcomingEvents.length.toString(),
                  icon: Icons.upcoming,
        ...
        Row(
          ...
          children: [
            ...
            QuickActionButton(
              ...
              onTap: () =>
                  _handleSmartNavigation(context, 'guests'),
            ),
            QuickActionButton(
              ...
              color: AppColors.success,
              onTap: () =>
                  _handleSmartNavigation(context, 'budget'),
            ),
            QuickActionButton(
              ...
              onTap: () =>
                  _handleSmartNavigation(context, 'tasks'),
            ),
          ],
        ),
      ],
  ...
  void _handleSmartNavigation(BuildContext context, String targetTab) {
    ...
    if (events.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text("Please create an event first!"),
  ...
  void _navigateToTab(
      BuildContext context, String eventId, String targetTab) {
    int tabIndex = 0;
    ...
    Navigator.pushNamed(context, AppRoutes.eventDetail,
        arguments: {'eventId': eventId, 'initialTab': tabIndex});
  }
        ...
        children: [
          ...
          ListView.separated(
            ...
            itemBuilder: (context, index) =>
                _buildRecentEventTile(context, recent[index]),
          ),
        ],
      );
    });
    ...
    return Scaffold(
      ...
      body: Consumer<UserEventProvider>(builder: (context, p, c) {
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                const Text("No events planned yet.",
                    style: TextStyle(
                        fontSize: 16,
                        color: AppColors.textSecondary)),
                const SizedBox(height: 20),
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) =>
              _EventCard(event: p.events[index]),
        );
      }),
    );
  }
...
class _SettingsTab extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Center(
            child: Text(auth.user?.name ?? 'User',
                style: const TextStyle(
                    fontSize: 22,
                    fontWeight: FontWeight.bold,
                    color: AppColors.textPrimary)),
          ...
          auth.isVendor 
            ? _buildSwitchToVendorCard(context)
            : _buildBecomeProfessionalCard(context),
          ...
          _buildSettingsTile(context,
              ...
              title: "Rate App",
              onTap: () => _launchUrl("https://play.google.com/store/apps/details?id=com.evora.app")), // Update with real package name
          _buildSettingsTile(context,
  ...
  Widget _buildBecomeProfessionalCard(BuildContext context) {
    return GestureDetector(
      onTap: () =>
          Navigator.pushNamed(context, AppRoutes.vendorRegistration),
      child: Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
                ...
                children: [
                  Text("Become a Professional",
                      style: TextStyle(
                          ...
                          color: AppColors.primary)),
                  SizedBox(height: 4),
                  Text("Earn money by providing event services",
                      style: TextStyle(
                          fontSize: 12,
                          color: AppColors.textSecondary)),
                ],
  ...
  Widget _buildSwitchToVendorCard(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.pushNamed(context, AppRoutes.vendorMain),
      child: Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          color: AppColors.primary.withOpacity(0.1),
                ...
                children: [
                  Text("Vendor Dashboard",
                      style: TextStyle(
                          ...
                          color: AppColors.primary)),
                  SizedBox(height: 4),
                  Text("Switch to your vendor management panel",
                      style: TextStyle(
                          fontSize: 12,
                          color: AppColors.textSecondary)),
                ],
