      ...
      case 'vendor':
        if (widget.vendorId != null) {
          ...
          await notificationProvider.addNotification(
            ...
            message: "Paid ${AppStrings.rupee}${widget.totalAmount.toStringAsFixed(0)} to '${widget.vendorName ?? 'Vendor'}'.",
          );
          // Note: Vendor notification happens via Cloud Functions or Vendor Panel listening to 'payments' collection
        }
        break;
      ...
      case 'expense':
        if (widget.expenseId != null) {
          ...
          await notificationProvider.addNotification(
            userId: userId,
            title: "Expense Paid! ✅",
            message: "Paid ${AppStrings.rupee}${widget.totalAmount.toStringAsFixed(0)} for '${widget.expenseName ?? 'Expense'}'.",
          );
        }
        break;
      ...
      case 'booking':
        if (widget.bookingId.isNotEmpty) {
          ...
          await notificationProvider.addNotification(
            ...
            message: "Paid ${AppStrings.rupee}${widget.totalAmount.toStringAsFixed(0)}.",
          );
        }
        break;
